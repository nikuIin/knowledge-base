...
**!!!** Также важно знать, что `useState`, все `useState` должны прогружать вместе c компонентом. Это означает, что мы не должны их добавлять в конструкции, например `if-else_if-else`. Еще раз: **все `useState` должны прогружаться вместе с компонетном.**
z
