# Художественная (`$= dv.pages("").where(page => { if (page["Тип"] && page["Тип"].path == "types/Книга.md" && !["templates", "templater"].includes(page.file.folder) && page.Категории && page.Категории.contains("художественная")) { return page; } }).length`)
...
const booksFiles = window.books.getBooks()
    .where(p => p["Категории"] && p["Категории"].contains("художественная"))
