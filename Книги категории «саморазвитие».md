...
---
---
# Саморазвитие (`$= dv.pages("").where(page => { if (page["Тип"] && page["Тип"].path == "types/Книга.md" && !["templates", "templater"].includes(page.file.folder) && page.Категории && page.Категории.contains("саморазвитие")) { return page; } }).length`)
```dataviewjs
// import code
eval(
...
const booksFiles = window.books.getBooks()
    .where(p => p["Категории"] && p["Категории"].contains("саморазвитие"))
